    ...
    <div className="min-h-screen lg:px-30 pt-5 md:pt-15 px-10 bg-white">
      ...
      <div className="flex flex-col items-center mt-5">
        ...
        >
          ...
          <button
            type="submit"
            className="text-center text-sm bg-gray-200 hover:bg-gray-300 transition-colors duration-200  p-2 rounded-box font-semibold flex justify-center items-center gap-2"
          >
            <svg
