...
export const Footer = () => {
  return (
    <footer className="bg-[#020f24] text-neutral-content p-10 pb-5">
      <div className="flex flex-col md:flex-row justify-between gap-10 max-w-7xl mx-auto text-sm ">
        <aside className="flex flex-col items-start gap-4">
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-blue-600 tracking-tight">
              Ever<span className="text-slate-200">Soft.</span>
            </h1>
          </div>
          <p>
            EverSoft Industries Ltd.
            <br />
            Providing reliable furnishings since 1992
          </p>
        </aside>

        <nav className="flex flex-col gap-2">
          <h6 className="footer-title font-bold text-white uppercase opacity-60">
            Services
          </h6>
          <a className="link link-hover">Delivery & Shipping</a>
        ...
        <div className="flex flex-col">
          <form>
            ...
            <fieldset className="w-full max-w-xs mt-4">
          ...
          <div className="flex gap-4 mt-4">
            <a>
              <svg
                ...
                className="fill-current hover:fill-yellow-200 hover:cursor-pointer"
              >
            ...
            <a>
              <svg
                ...
                width="24"
                height="24"
                className="fill-current hover:fill-red-400 hover:cursor-pointer"
              >
            ...
            <a>
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="hover:fill-blue-500 fill-current hover:cursor-pointer"
              >
      ...
      <div className="mt-10 pt-6 border-t border-slate-800 text-center text-sm opacity-60">
        <p>
